...
#         # ================Time==========================
        ...
        FacultyFrame.place(x=50,y=200,width=1300,height=400)
    ...
    Interaction with the students''')
        ...
        btn_print=Button(self.root,text="Print",cursor="hand2",font=("goudy old style",20,"bold"),bg="#ff4500",fg="#ffffff").place(x=1200,y=610,width=130,height=40)
