...
class FS:
    def __init__(self,root):
        ...
        btn_logout=Button(self.root, command=self.logout,text="Logout", font=("times new roman",15,"bold"),bg="#f8dcfb",cursor="hand2").place(x=1250,y=10,height=50,width=100)
...
#         #===============Content==============
        ...
        self.lbl_faculty.place(x=400,y=100,height=150,width=300)
        
        self.lbl_student=Label(self.root,text="Total Students\n[ 0 ]",bd=5,relief=RIDGE,bg="#c8f889",fg="#ef0289",font=("goudy old style",22,"bold"))
        self.lbl_student.place(x=950,y=100,height=150,width=300)
        
        self.lbl_rljit=Label(self.root,text="RLJIT",bd=5,relief=RIDGE,bg="#faf0e6",fg="#ef0289",font=("goudy old style",150,"bold"))
        self.lbl_rljit.place(x=400,y=320,height=300,width=800)
