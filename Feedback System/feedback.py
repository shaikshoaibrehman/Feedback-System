...
class Feedback:
    def __init__(self,root):
        ...
        btn_logout=Button(self.root, command=self.logout_feed,text="Logout", font=("times new roman",15,"bold"),bg="#f8dcfb",cursor="hand2").place(x=1250,y=10,height=50,width=100)
...
#         # ================Time==========================
        ...
        cmb_q1.place(x=700,y=295,width=180)
        cmb_q1.current(0)
        ...
        cmb_q2.place(x=700,y=355,width=180)
        cmb_q2.current(0)
        ...
        cmb_q3.place(x=700,y=420,width=180)
        cmb_q3.current(0)
    ...
    Clarification of doubts''',font=("times new roman" ,18,"bold")).place(x=250,y=480)
        ...
        cmb_q4.place(x=700,y=485,width=180)
        cmb_q4.current(0)
        ...
        cmb_q5.place(x=700,y=550,width=180)
        cmb_q5.current(0)
        ...
        FacultyFrame.place(x=950,y=300,width=398,height=300)
        ...
        btn_submit=Button(self.root,text="Submit",cursor="hand2",command=self.feedback,font=("goudy old style",20,"bold"),bg="#ff4500",fg="#ffffff").place(x=700,y=610,width=150,height=40)
